    ...
    <ion-page>
        <ion-content :fullscreen="true">
            ...
            <div class="waves-effect">
                <svg transform="rotate(180)" width="100%" height="100" viewBox="0 0 600 100"
            ...
            <ion-card class="mission">
                <ion-card-header>
                    <ion-card-title>
                        <h1 style="color: #c3237c; font-weight: bold">Vous êtes chez vous ici !</h1>
                    </ion-card-title>
                </ion-card-header>
                <ion-card-content>
                    <br />
                    <p>Vous pouvez naviguer entre plusieurs espaces LÉA pour vous renseigner sur l'association...</p>
                    <br />
                    <p>Belle navigation</p>
                    <br />
                    <h4 style="color: #c3237c">Jessica Baba - Fondatrice de l'association LÉA</h4>
                </ion-card-content>
            </ion-card>
            ...
            <ion-card-content>
                <img alt="enfant qui court avec un cervolant"
            ...
            <ion-card color="Medium-tint">
                <ion-card-content>
                    <p class="homParagraphe">L'association Léa est une association à but non lucratif (loi 1901)...</p>
                    <p class="homParagraphe homParagraphe2">Belle navigation</p>
                    <p class="homParagraphe">Jessica Baba - Fondatrice de l'association LÉA</p>
                </ion-card-content>
            </ion-card>


            <ion-card-content>
                <ion-button href="https://donner.asso-lea.org/jedonne/~mon-don" target="_blank" expand="block">
        ...
        <ion-footer class="ion-padding">
            <div id="footerSocialLink">
                <div class="contactInfo">
                    ...
                    <a class="phone-number" style="text-decoration: none" href="tel:0805950874">
                ...
                <a href="https://fr.linkedin.com/company/tousderrierelea" target="_blank">
...
import { IonPage, IonCard, IonCardContent, IonCardHeader, IonFooter, IonButton, IonContent, IonIcon } from '@ionic/vue';
import { call, logoFacebook, logoInstagram, logoLinkedin, logoTwitter, logoYoutube, walletOutline } from 'ionicons/icons';
